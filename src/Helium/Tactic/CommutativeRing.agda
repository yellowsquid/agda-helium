...
module Helium.Tactic.CommutativeRing where

open import Agda.Builtin.Reflection

open import Algebra hiding (CommutativeRing)
...
open import Helium.Tactic.CommutativeRing.NonReflective renaming (solve to solve-fn)
...
private
  ...
  checkIsRing ring = checkType ring (def (quote CommutativeRing) (3 ⋯⟨∷⟩ []))
